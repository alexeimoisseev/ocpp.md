...
- [OpenPeriodicEventStream](#openperiodiceventstream) (CS → CSMS)
- [ClosePeriodicEventStream](#closeperiodiceventstream) (CS → CSMS)
- [GetPeriodicEventStream](#getperiodiceventstream) (CSMS → CS)
- [AdjustPeriodicEventStream](#adjustperiodiceventstream) (CSMS → CS)
- [NotifyPeriodicEventStream](#notifyperiodiceventstream) (CS → CSMS (one-way SEND))
...
**Direction:** CS → CSMS (one-way SEND)
